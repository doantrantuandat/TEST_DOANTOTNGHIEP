...
# usage   = "Usage: %prog 'test.xlsx' 10 [options]"
...
class Eclat:
    ...
    def run(self, maxdepth=0):
        ...
        if self.verbose:
            ...
            if self.maxdepth: 
                print('and maxsize='+str(self.maxdepth))
                print('...', flush)
...
e = Eclat('test.txt', 2, output=True, outfilename='outfile.txt', maxdepth=6, verbose=True)
e.run()
